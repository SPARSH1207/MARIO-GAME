...
class Pipe extends Entity{
    constructor(tileset,posX,posY,width,height){
        let sprite= new Sprite(tileset,0,180,35,35);
        super(sprite,"pipe",posX,posY,width,height);
    }
}
...
class Stair extends Entity{
    constructor(tileset,xPos,yPos,width,height){
        let sprite= new Sprite(tileset,0,18,18,18);
...
class Shrub extends Entity{
    constructor(tileset,xPos,yPos,width,height){
        let sprite= new Sprite(tileset,198.5,162.5,53,17);
...
class Mountain extends Entity{
    constructor(tileset,xPos,yPos,width,height){
        let sprite= new Sprite(tileset,0,0,90,39);
...
class SmallCloud extends Entity{
    constructor(tileset,xPos,yPos,width,height){
        let sprite= new Sprite(tileset,64.5,0,33,24);
...
class MediumCloud extends Entity{
    constructor(tileset,xPos,yPos,width,height){
        let sprite= new Sprite(tileset,0,24.5,48,24);
        super(sprite,"cloud",xPos,yPos,width,height);
    }
}
...
class LargeCloud extends Entity{
    constructor(tileset,xPos,yPos,width,height){
        let sprite= new Sprite(tileset,0,0,64,24);
        super(sprite,"cloud",xPos,yPos,width,height);
    }
}
...
class Flag extends Entity{
    constructor(tileset,xPos,yPos,width,height){
        let sprite= new Sprite(tileset,289,153,16,27);
...
class Flagpole extends Entity{
    constructor(tileset,xPos,yPos,width,height){
        let sprite= new Sprite(tileset,289,163,16,18);
        super(sprite,"flag",xPos,yPos,width,height);
    }
}
...
class Castle extends Entity{
    constructor(tileset,xPos,yPos,width,height){
        let sprite= new Sprite(tileset,0,0,80,80);
        super(sprite,"cloud",xPos,yPos,width,height);
    }
}
